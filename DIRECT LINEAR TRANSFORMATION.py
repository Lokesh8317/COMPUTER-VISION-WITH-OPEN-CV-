...
# Load images
img1 = cv2.imread("C:/Users/maheshpabbisetti/OneDrive/Pictures/Saved Pictures/Naruto Wallpaper iPhone 4.png")
img2 = cv2.imread("C:/Users/maheshpabbisetti/OneDrive/Pictures/Saved Pictures/image edited.jpg")
